        ...
        return [
            ...
            /*'amendements' => [
                        ...
                        'sub_menu' => [
                            ...
                            'difficultes' => [
                                'icon' => '',
                                'route_name' => 'difficultes',
                                'params' => [
                                    'layout' => 'side-menu'
                                ],
                                //Layout 2 # Difficulter
                                'title' => 'Difficulter'
                            ]
                        ]
                    ],*/
            ...
            'users'             => [
                ...
                'sub_menu' => [
                    'users-layout-membre' => [
                        'icon'       => '',
                        'route_name' => 'users-layout-membre',
                        'params'     => [
                            'layout' => 'side-menu',
                        ],
                        'title'      => 'Utilisateurs',
                    ...
                    /*'users-layout-suivis' => [
                        'icon' => '',
                        'route_name' => 'users-layout-suivis',
                        'params' => [
                            'layout' => 'side-menu'
                        ],
                        'title' => 'Membre de suivi'
                    ],*/
                    /*'users-layout-point-focal' => [
                        'icon' => '',
                        'route_name' => 'users-layout-point-focal',
                        'params' => [
                            'layout' => 'side-menu'
                        ],
                        'title' => 'Point focal'
